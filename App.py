...
def build_unified_report_user_prompt_strong(name: str, matrix_md: str, p9: list[str], canon_texts_1_9: dict) -> str:
    ...
    return "\n".join([
        ...
        "   - НО сразу привяжите смысл к их конкретным позициям 1–6: что за тип ядра, что за социальный слой, чем это отличается от «обычного» типа.",
        ...
        "   - только логикой матрицы + тем, что уже сказано из канона.",
